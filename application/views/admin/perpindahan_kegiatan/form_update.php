...
<head>
  ...
  <title>Web Pindad | Data Kegiatan Keluar</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Tambah Data Kegiatan Keluar
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?= base_url('admin/data_kegiatanmasuk') ?>">Data Kegiatan</a></li>
          <li class="active">Tambah Data Kegiatan Keluar</li>
        </ol>
      </section>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Data Kegiatan Keluar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_data_keluar') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tanggal" style="margin-left:70px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->tanggal ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal_keluar" style="margin-left:220px;display:inline;">Tanggal Terlaksana</label>
                        <input type="text" name="tanggal_keluar" style="margin-left:36px;width:20%;display:inline;" class="form-control form_datetime" required="" placeholder="Klik Disini">
                      </div>
                      <div class="form-group" style="margin-bottom:40px;">
                        <label for="lokasi" style="margin-left:220px;display:inline;">Status</label>
                        <input type="text" name="lokasi" style="margin-left:116px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?= $d->lokasi ?>">
                      </div>
                      ...
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <input type="text" name="nama_barang" readonly="readonly" style="width:60%;" class="form-control" id="nama_Barang" value="<?= $d->jumlah ?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="satuan" style="width:73%;">PIC</label>
                        <select class="form-control" name="satuan" style="width:110%;margin-right: 80px;">
                      ...
                      <div class="form-group" style="display:inline-block;">
                        <label for="jenis" style="width:130px;margin-left:-40px;">Jenis Kegiatan</label>
                        <select class="form-control" name="jenis_kegiatan" style="width:100%; margin-left:-40px;">
