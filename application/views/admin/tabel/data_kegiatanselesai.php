...
<head>
  ...
  <title>Admin | Data Kegiatan Selesai</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/data_kegiatanselesai') ?>"><i class="fa fa-circle-o"></i> Data Kegiatan Selesai</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Data Kegiatan</li>
          <li class="active"><a href="<?= base_url('admin/data_kegiatanselesai') ?>">Data Kegiatan Selesai</a></li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/data_kegiatanmasuk') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Keluar</a>
