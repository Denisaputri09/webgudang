...
<head>
  ...
  <title>Web Pindad | Data Kegiatan Masuk | Update</title>
                  ...
                  <form action="<?= base_url('admin/proses_databarang_masuk_update') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tanggal" style="margin-left:30px;width:20%;display:inline;" class="form-control form_datetime" value="<?= $d->tanggal ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal_selesai" style="margin-left:220px;display:inline;">Tanggal Selesai</label>
                        <input type="text" name="tanggal_selesai" style="margin-left:20px;width:20%;display:inline;" class="form-control form_datetime" placeholder="Klik Disini" value="<?= $d->tanggal_selesai ?>">
                      </div>
