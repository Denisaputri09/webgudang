...
<head>
  ...
  <title>Web Pindad | Update PIC</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/data_pic') ?>"><i class="fa fa-circle-o"></i> Data PIC</a></li>
            </ul>
          </li>
          <li>
                        ...
                        <?php foreach ($data_satuan as $d) { ?>
                          <div class="box-body">
                            <div class="form-group" style="display:inline-block;">
                              ...
                              <label for="kode_satuan" style="width:87%;margin-left: 12px;">Nama Lengkap PIC</label>
                            ...
                            <div class="form-group" style="display:inline-block;">
                              <label for="nama_satuan" style="width:73%;">Kode PIC</label>
