...
<head>
  ...
  <title>Web Pindad | Input PIC</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/form_pic') ?>"><i class="fa fa-circle-o"></i> Tambah PIC</a></li>
            </ul>
          </li>
          <li class="treeview ">
            <a href="#">
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Data PIC</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_satuan_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        <label for="kode_satuan" style="width:87%;margin-left: 12px;">Nama Lengkap</label>
                        <input type="text" name="kode_satuan" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_satuan" placeholder="Masukan Nama Lengkap">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_satuan" style="width:73%;">Kode PIC [DL-Nama]</label>
                        <input type="text" name="nama_satuan" style="width:90%;margin-right: 67px;" class="form-control" id="nama_satuan" value="DL-">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                      ...
                      <div class="box-footer" style="width:93%;">
                        ...
                        <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?= base_url('admin/data_pic') ?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Data PIC</a>
                        <button type="submit" style="width:15%" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
                      </div>
                  </form>
                </div>
              </div>
