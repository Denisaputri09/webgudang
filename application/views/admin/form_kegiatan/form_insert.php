...
<head>
  ...
  <title>Web Pindad | Data Kegiatan Masuk</title>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?= base_url('admin/form_kegiatan') ?>"><i class="fa fa-circle-o"></i> Tambah Data Kegiatan Masuk</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Tambah Data Kegiatan Masuk</li>
        </ol>
      </section>
                  ...
                  <form action="<?= base_url('admin/proses_databarang_masuk_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="id_transaksi" style="margin-left:45px;width:20%;display:inline;" class="form-control" readonly="readonly" value="DL-<?= date("ymd"); ?><?= random_string('numeric', 2); ?>">
                      </div>
                      <div class="form-group">
                        <label for="tanggal" style="margin-left:220px;display:inline;">Tanggal Mulai</label>
                        <input type="text" name="tanggal" style="margin-left:30px;width:20%;display:inline;" class="form-control form_datetime" placeholder="Klik Disini">
                      </div>
                      <div class="form-group">
                        <label for="tanggal_selesai" style="margin-left:220px;display:inline;">Tanggal Selesai</label>
                        <input type="text" name="tanggal_selesai" style="margin-left:20px;width:20%;display:inline;" class="form-control form_datetime" placeholder="Klik Disini">
                      </div>
                      <div class="form-group" style="margin-bottom:40px;">
                        <label for="nama_barang" style="margin-left:220px;display:inline;">Status</label>
                      ...
                      <div class="box-footer" style="width:93%;">
                        ...
                        <a type="button" class="btn btn-info" style="width:15%;margin-right:24%" href="<?= base_url('admin/data_kegiatanmasuk') ?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat Data Kegiatan</a>
