  ...
  <nav class="navbar navbar-inverse navbar-fixed-top bg-dark">
    <div class="container">
      <div class="navbar-header">
        <a class="navbar-brand" href="<?= base_url('user') ?>">Web Kegiatan</a>
      </div>
      <ul class="nav navbar-nav mr-auto">
        ...
        <li class="dropdown"><a class="bg-dark dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-database" aria-hidden="true"></i> Data <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?= base_url('user/data_kegiatanmasuk'); ?>">Data Kegiatan Masuk</a></li>
            <li><a href="<?= base_url('user/data_kegiatanselesai'); ?>">Data Kegiatan Selesai</a></li>
            <!-- <li><a href="#">Data Kegiatan 3</a></li> -->
          </ul>
        </li>
