...
<div class="container text-center" style="margin: 2em auto;">
  <h2 class="tex-center">Data Kegiatan Selesai</h2>
  ...
  <div class="tabel" style="margin-top:80px">
    <table class="table table-bordered table-striped" style="margin: 2em auto;" id="data_kegiatanselesai">
      <thead>
        <tr>
          <th>No</th>
          <th>ID_Transaksi</th>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#data_kegiatanselesai').DataTable();
  });
</script>