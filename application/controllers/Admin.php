...
class Admin extends CI_Controller
{
  ...
  public function index()
  {
    if ($this->session->userdata('status') == 'login' && $this->session->userdata('role') == 1) {
      ...
      $data['stokBarangMasuk'] = $this->M_admin->sum('tb_barang_masuk', 'id_transaksi');
  ...
  public function form_kegiatan()
  {
    $data['list_satuan'] = $this->M_admin->select('tb_satuan');
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/form_kegiatan/form_insert', $data);
  }

  public function data_kegiatanmasuk()
  {
    $data = array(
    ...
    $this->load->view('admin/tabel/data_kegiatanmasuk', $data);
  }
  ...
  public function update_barang($id_transaksi)
  {
    ...
    $data['list_satuan'] = $this->M_admin->select('tb_satuan');
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/form_kegiatan/form_update', $data);
  }
  ...
  public function delete_barang($id_transaksi)
  {
    ...
    redirect(base_url('admin/data_kegiatanmasuk'));
  }
  ...
  public function proses_databarang_masuk_insert()
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      redirect(base_url('admin/form_kegiatan'));
    } else {
      $data['list_satuan'] = $this->M_admin->select('tb_satuan');
      $this->load->view('admin/form_kegiatan/form_insert', $data);
    }
  ...
  public function proses_databarang_masuk_update()
  {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $this->load->view('admin/form_kegiatan/form_update');
    }
  }
  ####################################
  ...
  public function form_pic()
  {
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/form_pic/form_insert', $data);
  }
  ...
  public function data_pic()
  {
    ...
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/tabel/data_pic', $data);
  }
  ...
  public function update_satuan()
  {
    ...
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/form_pic/form_update', $data);
  }
  ...
  public function delete_satuan()
  {
    ...
    redirect(base_url('admin/data_pic'));
  }
  ...
  public function proses_satuan_insert()
  {
    ...
    if ($this->form_validation->run() ==  TRUE) {
      ...
      redirect(base_url('admin/form_pic'));
    } else {
      $this->load->view('admin/form_pic/form_insert');
    }
  }
  ...
  public function proses_satuan_update()
  {
    ...
    if ($this->form_validation->run() ==  TRUE) {
      ...
      $this->load->view('admin/form_pic/form_update');
    }
  }
  ...
  public function barang_keluar()
  {
    ...
    $data['list_satuan'] = $this->M_admin->select('tb_satuan');
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/perpindahan_kegiatan/form_update', $data);
  }
  ...
  public function proses_data_keluar()
  {
    ...
    if ($this->form_validation->run() === TRUE) {
      ...
      $this->load->view('perpindahan_kegiatan/form_update/' . $id_transaksi);
    }
  }
  ####################################
  ...
  public function data_kegiatanselesai()
  {
    $data['list_data'] = $this->M_admin->select('tb_barang_keluar');
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user', $this->session->userdata('name'));
    $this->load->view('admin/tabel/data_kegiatanselesai', $data);
  }
}
